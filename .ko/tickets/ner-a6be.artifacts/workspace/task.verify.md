...
cd ui && npx vitest run
 ...
 ✓ src/ComposeBar.test.ts (8 tests) 604ms
...
[90m    at node:internal/deps/undici/undici:16416:13[39m
 ...
 ✓ src/ComposeBar-voice.test.ts (17 tests) 804ms
 ✓ src/Login.test.ts (10 tests) 581ms
 ✓ src/ComposeBar.image-attachment.test.ts (10 tests) 475ms
 ✓ src/ComposeBar.image-send.test.ts (5 tests) 396ms
 ✓ src/ComposeBar.image-mime.test.ts (4 tests) 386ms
 ✓ src/lib/markdown.test.ts (16 tests) 28ms
 ✓ src/Toast.test.ts (12 tests) 244ms
 ...
 ✓ src/lib/message-pinning.test.ts (30 tests) 8ms
 ✓ src/lib/image-attachment.test.ts (14 tests) 10ms
 ✓ src/lib/room-navigation.test.ts (25 tests) 9ms
 ...
 ✓ src/lib/message-display.test.ts (25 tests) 6ms
 ✓ src/lib/text-to-speech.test.ts (15 tests) 4ms
 ✓ src/lib/app-icon.test.ts (8 tests) 5ms
 ...
 Test Files  27 passed (27)
   ...
   Start at  03:24:31
   Duration  13.64s (transform 695ms, setup 1.30s, collect 3.32s, tests 3.63s, environment 12.68s, prepare 1.58s)
...
dist/assets/index-DBcyKsUN.css  21.58 kB │ gzip:  4.22 kB
dist/assets/index-J1yrNboq.js   80.46 kB │ gzip: 29.67 kB
✓ built in 945ms
cd src-tauri && cargo test
   Compiling nerve v0.1.0 (/home/dev/Projects/nerve/src-tauri)
    Finished `test` profile [unoptimized + debuginfo] target(s) in 17.78s
