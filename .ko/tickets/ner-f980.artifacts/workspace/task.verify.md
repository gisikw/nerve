...
Sending voice message: 10 bytes, 18ms, audio/webm;codecs=opus
...
[90m    at node:internal/deps/undici/undici:16416:13[39m
 ...
 ✓ src/ComposeBar-voice.test.ts (17 tests) 809ms
 ✓ src/Login.test.ts (10 tests) 570ms
 ✓ src/ComposeBar.image-attachment.test.ts (10 tests) 465ms
 ✓ src/ComposeBar.image-send.test.ts (5 tests) 419ms
 ✓ src/ComposeBar.image-mime.test.ts (4 tests) 378ms
 ✓ src/lib/markdown.test.ts (16 tests) 38ms
 ✓ src/Toast.test.ts (12 tests) 233ms
 ✓ src/lib/stores/error-feedback.test.ts (13 tests) 15ms
 ✓ src/lib/voice-recording.test.ts (16 tests) 12ms
 ✓ src/lib/image-attachment.test.ts (14 tests) 12ms
 ✓ src/lib/stores/rooms.test.ts (23 tests) 11ms
 ✓ src/lib/message-pinning.test.ts (30 tests) 7ms
 ✓ src/lib/room-navigation.test.ts (21 tests) 10ms
 ✓ src/lib/streams.test.ts (40 tests) 9ms
 ...
 ✓ src/lib/typing-indicators.test.ts (12 tests) 5ms
 ...
 Test Files  27 passed (27)
   ...
   Start at  02:58:12
   Duration  13.55s (transform 727ms, setup 1.27s, collect 3.60s, tests 3.67s, environment 12.61s, prepare 1.59s)
...
dist/assets/index-E87nxdNm.js   80.64 kB │ gzip: 29.76 kB
✓ built in 962ms
